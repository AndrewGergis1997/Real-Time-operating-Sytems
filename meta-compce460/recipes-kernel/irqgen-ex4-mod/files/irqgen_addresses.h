...
# define IRQGEN_REG_PHYS_BASE 	0x43c00000 		// DONE: find the right address for the register from the device tree
# define IRQGEN_REG_PHYS_SIZE 	0x10000 		// DONE: find the size of the register address space from the device tree
...
# define IRQGEN_CTRL_REG_F_ENABLE             BIT(0) // DONE: check in the reference documentation
# define IRQGEN_CTRL_REG_F_HANDLED            BIT(1) // DONE: check in the reference documentation
# define IRQGEN_CTRL_REG_F_ACK        GENMASK( 5, 2) // DONE: check in the reference documentation

# define IRQGEN_GENIRQ_REG_F_LINE     GENMASK( 3, 0) 	// DONE: check in the reference documentation
# define IRQGEN_GENIRQ_REG_F_DELAY    GENMASK( 19, 6) 	// DONE: check in the reference documentation
# define IRQGEN_GENIRQ_REG_F_AMOUNT   GENMASK( 31, 20) 	// DONE: check in the reference documentation
